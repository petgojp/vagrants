...
} elseif ( 'link_category' == $category_taxonomy ) {
	/**
 ...
 */
do_action( "{$category_taxonomy}_pre_edit_form", $tag, $category_taxonomy ); ?>
 ...
 * @since 3.7.0
 */
do_action( "{$category_taxonomy}_term_edit_form_tag" );
?>>
<input type="hidden" name="action" value="editedtag" />
<input type="hidden" name="tag_ID" value="<?php echo esc_attr($tag->term_id) ?>" />
<input type="hidden" name="taxonomy" value="<?php echo esc_attr($category_taxonomy) ?>" />
...
<?php } ?>
<?php if ( is_taxonomy_hierarchical($category_taxonomy) ) : ?>
		<tr class="form-field term-parent-wrap">
			...
			<td>
				...
				$dropdown_args = apply_filters( 'taxonomy_parent_dropdown_args', $dropdown_args, $category_taxonomy, 'edit' );
				wp_dropdown_categories( $dropdown_args ); ?>
				<?php if ( 'category' == $category_taxonomy ) : ?>
...
<?php endif; // is_taxonomy_hierarchical() ?>
		 ...
		 * @param string $taxonomy Current taxonomy slug.
		 */
		do_action( "{$category_taxonomy}_edit_form_fields", $tag, $category_taxonomy );
		?>
	</table>
<?php
// Back compat hooks
 ...
 * @param string $taxonomy Current taxonomy slug.
 */
do_action( "{$category_taxonomy}_edit_form", $tag, $category_taxonomy );
